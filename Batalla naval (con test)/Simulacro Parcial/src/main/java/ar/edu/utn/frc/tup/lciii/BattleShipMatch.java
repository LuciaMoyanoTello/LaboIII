...
public class BattleShipMatch {
     ...
     * @return true si input contiene y o Y, false si input cosntiene n o N, null para lo demas.
     */
    static Boolean getYesNoAnswer(String input) {

        Pattern pattern = Pattern.compile("[yYnN]", Pattern.CASE_INSENSITIVE );
        ...
        if(matcher.matches())
        {
            ...
            System.out.println("Error: la respuesta debe ser 'y', 'Y', 'n', 'N'");
            return null;
        }
