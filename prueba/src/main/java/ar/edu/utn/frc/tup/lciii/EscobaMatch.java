...
public class EscobaMatch {
    ...
    public Boolean isFinish() {
        if (humanUserPoints >= 15 && humanUserPoints > appUserPoints) {
            winner = humanUser;
            System.out.println("The player " + humanUser.getName() + " won with " + humanUserPoints + " points.");
            return true;
        } else if (appUserPoints >= 15 && appUserPoints > humanUserPoints) {
            winner = appUser;
            System.out.println("The player " + appUser.getName() + " won with " + appUserPoints + " points.");
            return true;
        } else {
