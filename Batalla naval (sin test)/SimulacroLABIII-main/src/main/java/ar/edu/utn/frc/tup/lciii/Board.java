...
public class Board {
    ...
    public void setShipOnBoard(Position position) {
        // TODO: Setear en el board el valor de SHIP en la posicion indicada por parametro
    ...
    public void initBoardEnemyFleet() {
        // TODO: Iniciar todo el board con el valor de HIDE
        for(int f = 0; f < ROWS; f++) {
            for(int c = 0; c < COLUMNS; c++) {
                this.board[f][c] = HIDE;
            }
