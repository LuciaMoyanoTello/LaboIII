...
public class BattleShipGame {
    ...
    public void setAppEnemyFleetBoard(Board board){this.appEnemyFleetBoard = board;}
        ...
        do {
            System.out.println("Donde quiere posicionar su barco?");
                ...
                if(isAvailablePosition(playerShips, position)) {
                    ...
                    System.out.println("Ya estableció esta posición");
                }
    ...
    public void printGameStatus() {
        ...
        System.out.println("Le queda: " + (FLEET_SIZE - GetPlayerSunkQuantity()));
        System.out.println("A la app le hundieron: " + GetAppSunkQuantity());
        System.out.println("Le queda: " + (FLEET_SIZE - GetAppSunkQuantity()));
    }
    ...
    public void goodbyeMessage() {
        ...
        System.out.println("El gandor fue" + winner);
    ...
    public void calculateScores() {
        ...
        if(winner != null && Objects.equals(player, winner)){
            ...
            appPlayer.setScore(appPlayer.getScore() + GetAppSunkQuantity());
